...
class BookingApiTest(unittest.TestCase):
    ...
    def test_seo_meta_routes_and_canonical_urls_render(self):
        ...
        self.assertIn("hero-after-dark-clean.webp", html)
        self.assertIn("forbs-exterior-clean.webp", html)
        ...
        self.assertIn("Винная карта", html)
        ...
        self.assertIn("Меню кухни, бара и вина", menu_html)
        self.assertIn("Барное меню", menu_html)
        self.assertIn("Винная карта", menu_html)
        ...
        self.assertIn("menu-wine-1.webp", menu_html)
        self.assertIn("menu-wine-2.webp", menu_html)
        self.assertIn("menu-bar.pdf", menu_html)
        self.assertIn("menu-wine.pdf", menu_html)
